  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-gray-400">Basic school identity and contact details</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label htmlFor="school-phone" className="block text-sm font-medium text-gray-300 mb-1">
            Phone Number
          </label>
          <input
            id="school-phone"
        ...
        <div className="md:col-span-2">
          <label htmlFor="school-website" className="block text-sm font-medium text-gray-300 mb-1">
            Website
          </label>
          <input
            id="school-website"
      ...
      <div className="pt-6 border-t border-gray-800">
        ...
        <p className="text-sm text-gray-400">Physical location of the school</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label htmlFor="school-city" className="block text-sm font-medium text-gray-300 mb-1">
            City
          </label>
          <input
            id="school-city"
        ...
        <div>
          <label htmlFor="school-state" className="block text-sm font-medium text-gray-300 mb-1">
            State
          </label>
          <select
            id="school-state"
        ...
        <div>
          <label htmlFor="school-zip" className="block text-sm font-medium text-gray-300 mb-1">
            ZIP Code
          </label>
          <input
            id="school-zip"
      ...
      <div className="pt-6 border-t border-gray-800">
        ...
        <p className="text-sm text-gray-400">Licensing, accreditation, and classification</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label htmlFor="school-license" className="block text-sm font-medium text-gray-300 mb-1">
            License Number
          </label>
          <input
            id="school-license"
        ...
        <div>
          <label htmlFor="school-accreditation" className="block text-sm font-medium text-gray-300 mb-1">
            Accreditation
          </label>
          <input
        ...
        <div>
          <label htmlFor="school-type" className="block text-sm font-medium text-gray-300 mb-1">
            School Type
          </label>
          <select
            id="school-type"
        ...
        <div>
          <label htmlFor="school-timezone" className="block text-sm font-medium text-gray-300 mb-1">
            Time Zone
          </label>
          <select
            id="school-timezone"
