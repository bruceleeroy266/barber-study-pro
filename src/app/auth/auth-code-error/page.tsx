    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-charcoal to-black flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            href="/login"
            className="px-6 py-3 bg-[var(--color-brand-gold)] hover:bg-[var(--color-brand-gold)] text-black font-semibold rounded-lg transition-colors"
          >
            Sign in
          </Link>
          <Link
            href="/"
            className="px-6 py-3 bg-graphite hover:bg-[var(--color-border-secondary)] text-white font-semibold rounded-lg transition-colors"
          >
            Back to home
          </Link>
        </div>
