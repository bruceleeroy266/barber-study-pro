    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          <div className="bg-charcoal border border-graphite rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              <div>
                <label className="block text-sm font-medium text-light-gray mb-2">To</label>
                <div className="flex items-center gap-2">
                  <input
                    type="text"
                    value={email}
                    readOnly
                    className="flex-1 px-3 py-2 bg-black border border-graphite rounded-lg text-light-gray text-sm"
                  />
                  <button
                    type="button"
                    onClick={handleCopyEmail}
                    className="inline-flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-light-gray bg-graphite hover:bg-[var(--color-border-secondary)] rounded-lg transition-colors"
                  >
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-3 py-2 bg-black border border-graphite rounded-lg text-white text-sm focus:outline-none focus:border-[var(--color-brand-gold)]"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 bg-black border border-graphite rounded-lg text-white text-sm focus:outline-none focus:border-[var(--color-brand-gold)] resize-y"
                />
              </div>
              ...
              {status === 'error' && (
                <div className="flex items-center gap-2 p-3 bg-silver/10 border border-silver/20 rounded-lg text-silver text-sm">
              ...
              <div className="flex items-center justify-end gap-3 pt-2">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-[var(--color-brand-black)] bg-[var(--color-brand-gold)] rounded-lg hover:bg-[var(--color-brand-gold-light)] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
