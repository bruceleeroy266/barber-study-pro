        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          {submitted ? (
            <div className="bg-[var(--color-brand-black)] border border-[var(--color-brand-gold)]/30 rounded-2xl p-8 md:p-12 text-center">
              ...
              <Link
                href="/"
                className="inline-flex px-8 py-4 bg-[var(--color-brand-gold)] text-[var(--color-background-primary)] font-bold rounded-xl hover:bg-[var(--color-brand-gold-light)] transition-all"
              >
                Back to Home
              </Link>
            </div>
            ...
            <div className="bg-[var(--color-brand-black)] border border-white/10 rounded-2xl p-8 md:p-12">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label htmlFor="school" className="block text-sm font-medium text-light-gray mb-2">
                      School
                    </label>
                    <input
                      type="text"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="state" className="block text-sm font-medium text-light-gray mb-2">
                      State *
                    </label>
                    <select
                      id="state"
                  ...
                  <div>
                    <label htmlFor="studentCount" className="block text-sm font-medium text-light-gray mb-2">
