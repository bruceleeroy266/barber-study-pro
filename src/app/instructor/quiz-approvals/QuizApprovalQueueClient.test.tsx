...
describe('QuizApprovalQueueClient filters', () => {
  it('filters by chapter, class/program, and student', () => {
    ...
    expect(screen.getByRole('article')).toHaveTextContent('Alex Barber')
    expect(screen.getByRole('article')).not.toHaveTextContent('Jordan Cosmo')
    ...
    expect(screen.getAllByRole('article')).toHaveLength(1)
    expect(screen.getByRole('article')).toHaveTextContent('Jordan Cosmo')
    expect(screen.getByRole('article')).not.toHaveTextContent('Alex Barber')
