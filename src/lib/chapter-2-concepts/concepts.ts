 ...
 * Provenance uses neutral ASCYN PRO classifications:
 *   INDUSTRY_STANDARD_SUBJECT_MATTER = established professional knowledge expressed in ASCYN PRO wording
 *   ASCYN_ORIGINAL = original ASCYN PRO enrichment and extensions
 */
...
export const chapter2LearningObjectives: readonly Chapter2LearningObjective[] = [
  {
    ...
    sourceBasis: 'Industry-standard life-skills subject matter; ASCYN Section 1',
  ...
  },
  {
    ...
    sourceBasis: 'Industry-standard personal and professional success subject matter; ASCYN Section 11',
    professionalRelevance: 'CORE',
    examRelevance: 'INDIRECT_REFERENCE_ONLY',
  ...
  },
  {
    ...
    sourceBasis: 'Industry-standard professional attitude and mission-setting subject matter; ASCYN flashcards',
    professionalRelevance: 'CORE',
    examRelevance: 'INDIRECT_REFERENCE_ONLY',
  ...
  },
  {
    ...
    sourceBasis: 'Industry-standard goal-setting subject matter with ASCYN-applied frameworks; ASCYN Section 2',
  ...
  },
  {
    ...
    sourceBasis: 'Industry-standard time-management subject matter with ASCYN-applied tools and techniques; ASCYN Section 3',
    professionalRelevance: 'SUPPORTING',
    examRelevance: 'NONE',
  ...
  },
  {
    ...
    sourceBasis: 'Industry-standard study and learning-strategy subject matter; ASCYN Section 4',
    professionalRelevance: 'SUPPORTING',
    examRelevance: 'NONE',
  ...
  },
  {
    ...
    sourceBasis: 'Industry-standard professional ethics and confidentiality subject matter with ASCYN service-recovery application; ASCYN Section 9',
    professionalRelevance: 'CORE',
    examRelevance: 'INDIRECT_REFERENCE_ONLY',
  ...
  },
  {
    ...
    sourceBasis: 'Industry-standard stress-management and work-life-balance subject matter; ASCYN Section 5',
    professionalRelevance: 'SUPPORTING',
    examRelevance: 'NONE',
  ...
  },
  {
    ...
    sourceBasis: 'Industry-standard professional communication subject matter with ASCYN listening, consultation, and conflict applications; ASCYN Sections 8, 10',
    professionalRelevance: 'CORE',
    examRelevance: 'INDIRECT_REFERENCE_ONLY',
  ...
  },
  {
    ...
    sourceBasis: 'ASCYN-original networking content plus industry-standard career-specialization subject matter; ASCYN Sections 6, 13',
    professionalRelevance: 'SUPPORTING',
    examRelevance: 'NONE',
  ...
  },
  {
    ...
    sourceBasis: 'ASCYN-original financial-literacy enrichment; ASCYN Section 7',
    professionalRelevance: 'SUPPORTING',
    examRelevance: 'NONE',
    conceptIds: ['C-2-21'],
  },
  {
    ...
    sourceBasis: 'Industry-standard inclusive-service and cultural-competence subject matter; ASCYN Section 12',
    professionalRelevance: 'CORE',
    examRelevance: 'INDIRECT_REFERENCE_ONLY',
    conceptIds: ['C-2-23'],
  },
  {
    ...
    sourceBasis: 'ASCYN-original leadership and mentorship enrichment; ASCYN Section 14',
    professionalRelevance: 'SUPPORTING',
    examRelevance: 'NONE',
    conceptIds: ['C-2-25'],
  },
  {
    ...
    sourceBasis: 'Industry-standard workplace professionalism and shop-etiquette subject matter; ASCYN Section 15',
    professionalRelevance: 'CORE',
    examRelevance: 'INDIRECT_REFERENCE_ONLY',
    conceptIds: ['C-2-26'],
  },
