  ...
  sections: [
      ...
      tabs: [
        {
          ...
          title: 'THE BLADE',
          bullets: [
            { label: 'MATERIAL', description: 'Shear performance depends on alloy, heat treatment, blade geometry, workmanship, and maintenance; country-of-origin labels alone do not establish quality' },
        ...
        },
        {
          ...
          facts: [
            { text: 'Check shear tension regularly and whenever cutting performance changes; follow the manufacturer guidance for adjustment.' },
      ...
      tabs: [
        {
          ...
          facts: [
            { text: 'SKILL-RELEVANT: Palming can support safe, controlled tool transitions. Verify the current practical-exam bulletin for any jurisdiction-specific technique requirements.' },
        ...
        },
        {
          ...
          facts: [
            { text: 'Build a smooth, controlled transition without sacrificing blade awareness, client safety, or cutting accuracy.' },
    ...
    // ==========================================
    {
      ...
      items: [
        ...
        { text: 'SHARPEN AS NEEDED - follow the shear manufacturer guidance and use a qualified shear sharpener' },
      ...
      tabs: [
        ...
        },
        {
          ...
          bullets: [
            ...
            { label: 'OIL BEFORE EACH USE', description: 'oil placement and quantity specified by the clipper manufacturer' },
            { label: 'SPRAY DISINFECTANT', description: 'Between clients, clean and disinfect removable clipper blades/guards as required by current rules and the disinfectant label' },
      ...
      tabs: [
        ...
        },
        {
          ...
          facts: [
            ...
            { text: 'Pressing combs are one thermal-tool option for appropriate textured-hair services; use them only when suitable for the service and hair condition.' },
          ],
        },
        {
          id: 'blowdryer',
    ...
    // ==========================================
    {
      ...
      items: [
        ...
        { text: 'EPA-REGISTERED DISINFECTANT - Use a product approved for the intended barber/salon use site and follow its label' },
        { text: 'DISINFECTION CONTAINER - Use an appropriate labeled container/method when immersion is required by the product label or current rules' },
        { text: 'DISPOSABLE GLOVES - Nitrile or latex, changed between clients' },
        { text: 'BLOOD-EXPOSURE SUPPLIES - Follow current state rules and universal precautions; use only permitted products and single-use applicators' },
        { text: 'AFTERSHAVE/ASTRINGENT - Use for its labeled cosmetic purpose; do not substitute it for required skin antisepsis or surface disinfection' },
