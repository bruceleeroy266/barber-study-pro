...
export const demoSchool = {
  ...
  website: 'https://demobarberacademy.test',
  timezone: 'America/Chicago',
  license_number: 'OK-BARBER-2026-001',
  accreditation: 'NACCAS',
  school_type: 'barber' as const,
...
export const demoChapters: Chapter[] = [
  ...
  { id: 'ch-19', chapter_number: 19, title: 'Preparing for Licensure and Employment', description: 'Prepare for state licensure, job search, résumé and portfolio development, interviews, and employment contracts.', content: null, order_index: 19, is_active: true },
  { id: 'ch-20', chapter_number: 20, title: 'Working Behind the Chair', description: 'Professional expectations, teamwork, compensation, money management, retailing, upselling, and client retention.', content: null, order_index: 20, is_active: true },
...
// Chapter 19: Use premium flashcards (real content)
if (realFlashcards['ch-19'] && realFlashcards['ch-19'].length > 0) {
...
// Chapter 20: Use premium flashcards (real content)
if (realFlashcards['ch-20'] && realFlashcards['ch-20'].length > 0) {
...
// Chapter 21: Use premium flashcards (real content)
if (realFlashcards['ch-21'] && realFlashcards['ch-21'].length > 0) {
...
export const demoQuizzes: Record<string, Quiz> = {
  ...
  'ch-4': { id: 'quiz-4', chapter_id: 'ch-4', title: 'Infection Control — Premium Quiz', description: '30 board-exam style questions. Passing score: 80%.', is_active: true, passing_score: 80 },
  // Chapter 5: Premium flashcard-driven quiz (50 questions)
  'ch-5': { id: 'quiz-5', chapter_id: 'ch-5', title: 'Implements, Tools, and Equipment — Premium Quiz', description: '50 board-exam style questions. Passing score: 80%.', is_active: true, passing_score: 80 },
  // Chapter 6: Premium flashcard-driven quiz (50 questions)
  'ch-6': { id: 'quiz-6', chapter_id: 'ch-6', title: 'General Anatomy and Physiology — Premium Quiz', description: '50 board-exam style questions. Passing score: 80%.', is_active: true, passing_score: 80 },
  // Chapter 7: Premium flashcard-driven quiz (50 questions)
  'ch-7': { id: 'quiz-7', chapter_id: 'ch-7', title: 'Basics of Chemistry — Premium Quiz', description: '50 board-exam style questions. Passing score: 80%.', is_active: true, passing_score: 80 },
  // Chapter 8: Premium flashcard-driven quiz (30 questions)
  'ch-8': { id: 'quiz-8', chapter_id: 'ch-8', title: 'Basics of Electricity — Premium Quiz', description: '30 board-exam style questions. Passing score: 80%.', is_active: true, passing_score: 80 },
  // Chapter 9: Premium flashcard-driven quiz (30 questions)
  'ch-9': { id: 'quiz-9', chapter_id: 'ch-9', title: 'The Skin — Premium Quiz', description: '30 board-exam style questions. Passing score: 80%.', is_active: true, passing_score: 80 },
  // Chapter 10: Premium flashcard-driven quiz (65 questions)
  'ch-10': { id: 'quiz-10', chapter_id: 'ch-10', title: 'Properties and Disorders of the Hair and Scalp — Premium Quiz', description: '65 board-exam style questions. Passing score: 80%.', is_active: true, passing_score: 80 },
  // Chapter 11: Premium flashcard-driven quiz (50 questions)
  'ch-11': { id: 'quiz-11', chapter_id: 'ch-11', title: 'Treatment of the Hair and Scalp — Premium Quiz', description: '50 board-exam style questions. Passing score: 80%.', is_active: true, passing_score: 80 },
  // Chapter 12: Premium flashcard-driven quiz (45 questions)
  'ch-12': { id: 'quiz-12', chapter_id: 'ch-12', title: "Men's Facial Massage and Treatments — Premium Quiz", description: '45 board-exam style questions. Passing score: 80%.', is_active: true, passing_score: 80 },
  // Chapter 13: Premium flashcard-driven quiz (45 questions)
  'ch-13': { id: 'quiz-13', chapter_id: 'ch-13', title: 'Shaving and Facial-Hair Design — Premium Quiz', description: '45 board-exam style questions. Passing score: 80%.', is_active: true, passing_score: 80 },
  // Chapter 14: Premium flashcard-driven quiz (70 questions)
  'ch-14': { id: 'quiz-14', chapter_id: 'ch-14', title: "Men's Haircutting and Styling — Premium Quiz", description: '70 board-exam style questions. Passing score: 80%.', is_active: true, passing_score: 80 },
...
for (let i = 3; i <= 21; i++) {
  ...
  if (!demoQuizzes[chId]) {
    demoQuizzes[chId] = { id: `quiz-${i}`, chapter_id: chId, title: `Chapter ${i} Quiz`, description: `Test your knowledge of Chapter ${i}.`, is_active: true, passing_score: 80 }
  }
}
