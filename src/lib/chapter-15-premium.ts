...
export const chapter15PremiumContent: ChapterContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      title: 'Board Exam Alert: The 24â€“48 Hour Cure Time',
    ...
    },
    {
      ...
      highlight: 'First cleaning after one week; then every 3â€“4 weeks',
    },
    {
      type: 'contentBlock',
    ...
    },
    {
      ...
      items: [
        ...
        { text: 'Trap: "A bonded client can shampoo immediately." — FALSE. Wait 24â€“48 hours for full cure.' },
    ...
    // Section 13: Board Exam Checkpoint
    {
      ...
      levels: [
        ...
        { level: '7', title: 'Maintenance', description: 'Can explain cleaning schedules, temperature rules, and the 24â€“48 hour cure time', reward: 'Longer system lifespan' },
    ...
    },
    {
      ...
      items: [
        { text: 'âœ“ Terminology evolved: toupee â†’ hairpiece â†’ hair replacement system â†’ hair solution' },
        { text: 'âœ“ Hair replacement is the second fastest-growing market in barbering' },
        { text: 'âœ“ Consultations must be private, personal, and ethical' },
        { text: 'âœ“ Use the LAB MED framework: Lifestyle, Age, Budget, Medical, Expectations, Daily maintenance' },
        { text: 'âœ“ Never promise unrealistic results — credibility depends on honesty' },
        { text: 'âœ“ Marketing works best through social media, in-shop displays, referrals, and personal experience' },
        { text: 'âœ“ Always obtain signed model releases before using client photos' },
        { text: 'âœ“ Know all alternatives: cover-up fibers, Minoxidil, Finasteride, laser therapy, transplantation, scalp reduction, flap surgery' },
        { text: 'âœ“ Barbers inform and refer — never prescribe, diagnose, or perform surgery' },
        { text: 'âœ“ Human hair: most natural, processable, high maintenance' },
        { text: 'âœ“ Synthetic hair: holds style, lower cost, limited chemical processing' },
        { text: 'âœ“ Mixed hair: human + synthetic/animal fibers for specialized applications' },
        { text: 'âœ“ Base types: mesh (breathable), polyurethane (waterproof), lace (invisible hairline), thin skin (undetectable edge), combination (industry standard)' },
        { text: 'âœ“ Knotting methods: single knot, double knot, V-loop, single hair injection' },
        { text: 'âœ“ Root-turning prevents tangling by aligning cuticles in natural growth direction' },
        { text: 'âœ“ Stock systems: faster, cheaper, standard sizes — customize with cutting' },
        { text: 'âœ“ Custom systems: perfect fit, higher cost, longer timeline — made from templates or plaster molds' },
        { text: 'âœ“ Measure in inches: length by width (e.g., 6x4 means 6" front-to-back, 4" side-to-side)' },
        { text: 'âœ“ Take color samples from crown, temple, side, and back — especially for gray blending' },
        { text: 'âœ“ Full head bonding: most secure, waterproof, 24â€“48 hour cure time before shampooing' },
        { text: 'âœ“ Never apply tape directly to lace — it will tear' },
        { text: 'âœ“ Facial hair attaches with spirit gum on clean, dry skin' },
        { text: 'âœ“ Clean synthetic systems with solvent and lukewarm water only — hot water causes shrinkage' },
        { text: 'âœ“ Clean human hair systems with manufacturer-formulated shampoo and conditioner' },
        { text: 'âœ“ First cleaning after one week; then every 3â€“4 weeks' },
        { text: 'âœ“ Clients need at least two systems for rotation' },
        { text: 'âœ“ Never fold systems — store flat on a block' },
        { text: 'âœ“ Top section cut at 90° elevation; sides tapered with slide cutting; back blended with thinning shears' },
        { text: 'âœ“ Floating perm rods above the base using roller picks — never let rods rest on the base' },
        { text: 'âœ“ Use temporary color rinses only — never lighten or cold-wave a system' },
        { text: 'âœ“ Scope of practice: barbers measure, fit, cut, style, clean, and maintain — physicians prescribe and perform surgery' },
      ],
    },
  ],
}
